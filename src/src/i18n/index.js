...
Create_resort:"New resort",
    ...
    change_your_resort_later: 'In the future, if you wish to change your resort, go your account\'s settings',
  ...
  fr: {
   ...
   cancel_sign_up: 'Annuler l\'inscription',
    ...
    change_your_resort_later: 'A l’avenir si vous souhaitez changer de station, rendez-vous dans vos paramètres de compte.',
