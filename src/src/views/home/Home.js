...
//    OneSignal.removeEventListener('ids', this.onIds);
  ...
  componentWillReceiveProps(nextProps) {
    if (this.oneSignalUserId && !nextProps.data.loading && this.shouldUpdateOneSignalUserId(nextProps.data.me.oneSignalUserId, this.oneSignalUserId)) {
...
const firstName=(me)?capitalize(me.firstName):"";

    return (
      <Container asScroll title={`${translate('hello')}, ${firstName} !`}>
        <View style={styles.messageOfTheDay}>
          {
            !!me&&!!me.selectedShop.MOTD && <Title font={font} size={16}>{me.selectedShop.MOTD}</Title>
          }
        </View>
          <BigRedButton
        ...
        {!!me&&me.selectedShop.bestSellerProducts.length > 0 && (
          <SimpleProductList
        ...
        {!!me&&me.selectedShop.newProducts.length > 0 && (
          <SimpleProductList
